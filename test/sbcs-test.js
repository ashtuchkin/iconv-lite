...
for (var enc in iconv.encodings) {
    if (iconv.encodings[enc].type === '_sbcs' && !skipEncodings[enc]) (function(enc) {
        ...
        sbcsEncodingTests["Decode SBCS encoding '" + enc + "'"] = function() {
        ...
        sbcsEncodingTests["Encode SBCS encoding '" + enc + "'"] = function() {
...
vows.describe("SBCS encoding tests")
    .addBatch(sbcsEncodingTests)
    .export(module);
