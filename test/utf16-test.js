...
const testStr = "1aя中文☃💩"
const utf16beBuf = utils.bytesFrom([0, 0x31, 0, 0x61, 0x04, 0x4f, 0x4e, 0x2d, 0x65, 0x87, 0x26, 0x03, 0xd8, 0x3d, 0xdc, 0xa9])
const utf16leBuf = utils.bytesFrom([0x31, 0, 0x61, 0, 0x4f, 0x04, 0x2d, 0x4e, 0x87, 0x65, 0x03, 0x26, 0x3d, 0xd8, 0xa9, 0xdc])
const utf16beBOM = utils.bytesFrom([0xFE, 0xFF])
const utf16leBOM = utils.bytesFrom([0xFF, 0xFE])
const sampleStr = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<数据>נְתוּנִים</数据>"
const weirdBuf = utils.bytesFrom([0x15, 0x16, 0x17, 0x18])  // Can't automatically detect whether it's LE or BE.
