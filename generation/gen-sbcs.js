...
// Write encodings.
fs.writeFileSync(
    path.join(__dirname, "..", destFileName),
    '"use strict";\n\n// Generated data for sbcs codec. Don\'t edit manually. Regenerate using generation/gen-sbcs.js script.\n' +
        "module.exports = " +
        JSON.stringify(encodings, undefined, "  ")
);
...
function generateCharsString(encoding) {
    ...
    if (containsDiacritics.length > 0)
        console.log(
            "Contains Diacritics: ",
            containsDiacritics.map((d) => d.toString(16))
        );
