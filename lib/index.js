...
function TransliterationWrapper(encoder, options) {
    ...
    this.options = { deferredSmartSpacing: this.smartSpacing, german: options && options.german };
    this.pending = '';
}
...
TransliterationWrapper.prototype.end = function() {
    ...
    if (this.pending) {
        buf = this.encoder.write(unidecode.resolveSpacing(this.pending));
        this.pending = '';
    }
...
iconv.hasUnidecodePlus = function hasUnidecodePlus() {
