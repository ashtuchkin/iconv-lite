...
iconv.getCodec = function getCodec(encoding) {
    ...
    var enc = (''+encoding).toLowerCase().replace(RE_STRIP_CHARS, "");
...
var ASCII_COMPAT_MAP;
iconv.asciiCompatible = function asciiCompatible(enc) {
  if (!ASCII_COMPAT_MAP)
    ASCII_COMPAT_MAP = require('../encodings/ascii-compat-generated');
  enc = enc.toLowerCase().replace(RE_STRIP_CHARS, '');
  return (ASCII_COMPAT_MAP[enc] || false);
};
